...
- Download WAV của kết quả gần nhất.

## 5. Acceptance criteria
- Text hợp lệ -> synthesize thành công -> audio phát được.
- Text rỗng bị chặn từ client.
- Request fail hoặc timeout hiển thị lỗi rõ ràng và không làm UI kẹt.

## 6. Điều kiện hoàn thành
- Có smoke path: load voices -> nhập text -> synthesize -> play -> download.
